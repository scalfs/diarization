...
base_dir = '/app'
rttm_dir = f'{base_dir}/voxcon-test-rttm'
...
for idx, sample_id in enumerate(sample_ids):
    ...
    print('Predicted labels: ', audio_id, f' {idx}/{len(sample_ids)}')
    ...
    rttm_file = f'{rttm_dir}/rttm/{}.rttm'.format(audio_id)
    with open(rttm_file, 'w') as file:
        annotation.support().write_rttm(file)

    rttm_file_collar = f'{rttm_dir}/rttm_colar/{}.rttm'.format(audio_id)
